...
以下是之前写的[前端开发规范](https://juejin.im/post/5d300e0fe51d4577407b1dff)配套的 eslint，具体每一条规则什么意思都已经写明了，如果还有不清楚的，给大家个[传送门](http://eslint.cn/docs/rules/)，自行搜索一下吧~

如果使用了 react 或者 vue 的话，需要在 extends 中添加 react 或者 vue 的校验，vue 可以直接参考 [eslint-config-vue](https://github.com/vuejs/eslint-config-vue)、[规则归类](https://vuejs.bootcss.com/v2/style-guide/?#%E8%A7%84%E5%88%99%E5%BD%92%E7%B1%BB)、[eslint-plugin-vue](https://eslint.vuejs.org/)，react 的话需要自行搜索一下。
